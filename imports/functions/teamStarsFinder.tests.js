...
if (Meteor.isClient) {
  describe('reusable functions - teamStarsFinder', function () {
    it('should take an array of objects as its input, do some work on the array, and compare its output with a manually entered array of objects, checking if they\'re deeply equal', function () {
